...
(function () {
  ...
  const DICT = {
    es: {
      ...
      "hero.title.b":    ".",
      "hero.lead":       "Automatizamos procesos críticos para empresas en crecimiento en 10-15 días, con alcance cerrado, métricas claras y sistemas en producción.",
      "hero.cta.primary":"Agendar diagnóstico 60 min",
      "hero.cta.ghost":  "Calcular ahorro",
    ...
    en: {
      ...
      "hero.title.b":    ".",
      "hero.lead":       "We automate critical workflows for growing companies in 10-15 days, with fixed scope, clear metrics and production-ready systems.",
      "hero.cta.primary":"Book a 60-min diagnostic",
      "hero.cta.ghost":  "Estimate savings",
