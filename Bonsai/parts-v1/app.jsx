  ...
  return (
    <section className="hero">
      ...
      <div className="wrap hero-grid">
        <div>
          <span className="eyebrow">AI-native software · Asunción / LATAM</span>
          <h1 className="h-display">
            Intelligent systems for <em>growing companies</em>.
          </h1>
          <p className="lead">
            We turn manual operations into intelligent systems. Software, automation,
            and AI-enabled internal tools for companies moving from scattered spreadsheets
            into structured systems that scale.
          </p>
          <div className="hero-ctas">
            ...
            <a className="btn btn-ghost" href="#bonsai-os">See Bonsai OS</a>
          </div>
          <div className="hero-stats">
            <div>
              <div className="v">10–15<span style={{fontSize:14,fontWeight:500,opacity:.6,marginLeft:6}}>days</span></div>
              <div className="k">Automation Sprint</div>
            </div>
            <div>
              <div className="v">37.6%</div>
              <div className="k">Avg client operating margin</div>
            </div>
            <div>
              <div className="v">+2.5×</div>
              <div className="k">Observed DSCR post-implementation</div>
            </div>
          </div>
        </div>
        <OSPreview />
